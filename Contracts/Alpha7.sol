...
*Taxes as follows Reflections to holders, NFT Reflection (Alpha Dawg NFT), LP additions, marketing
*/
...
contract Alpha7Token is Context, IBEP20, Ownable {
    ...
    uint256 public maxTxAmount = 50000000 * 10**_decimals;  // Setting the max transaction limit

    uint256 public swapTokensAtAmount = 7e7 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 1;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public nftRewardWallet = 0x3f39B8d07f4568bf2A653494a3584069d0f68227;
    address private opsWallet = 0x3f39B8d07f4568bf2A653494a3584069d0f68227;
    address private devWallet = 0x3f39B8d07f4568bf2A653494a3584069d0f68227;

    string private constant _name = "Alpha7";
    string private constant _symbol = "Alpha7";
    ...
    Taxes public taxes = Taxes(1, 2, 0, 1, 3);
    Taxes public sellTaxes = Taxes(1, 2, 0, 1, 33);
    ...
    // Function to update the max transaction amount (optional)
